...
未認証ミニアプリでは、[ヘッダー](https://developers.line.biz/ja/docs/line-mini-app/discover/ui-components/#header)にタイトルとエンドポイントURLのドメイン名が表示されます。

![](https://developers.line.biz/media/line-mini-app/unverified-mini-app-header-ja.png)

### 認証済ミニアプリとは 

弊社による認証審査に通過すると、そのLINEミニアプリは認証済ミニアプリとなります。認証済ミニアプリになると、[ヘッダー](https://developers.line.biz/ja/docs/line-mini-app/discover/ui-components/#header)などに認証バッジがつきます。また、ヘッダーにはタイトルとLINEミニアプリ名が表示されます。

![](https://developers.line.biz/media/line-mini-app/verified-mini-app-header-ja.png)
