...
アプリ内課金で購入可能なアイテムは、LINEプラットフォーム側で事前に定義されています。詳しくは、「[アプリ内課金で購入可能なアイテムのプロダクトID一覧](https://developers.line.biz/ja/docs/line-mini-app/in-app-purchase/iap-product-id/)」を参照してください。
