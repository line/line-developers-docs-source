...
- [リッチメニューの統計情報（合計）を取得する](https://developers.line.biz/ja/reference/messaging-api/#get-rich-menu-insight-summary)
- [リッチメニューの統計情報（日別）を取得する](https://developers.line.biz/ja/reference/messaging-api/#get-rich-menu-insight-daily)

なお、Messaging APIとLINE Official Account Managerで作成したリッチメニューは、それぞれ作成したツールでのみ統計情報を参照できます。

| リッチメニューを作成したツール | Messaging APIで</br>統計情報を取得 | LINE Official Account Managerで</br>統計情報を確認 |
| --- | --- | --- |
| Messaging API | ✅ | ❌ |
