...
- [クラウドネイティブ・アプリケーションプラットフォーム（CNAP）](https://www.softbank.jp/business/service/platform/msp-service/cnap)
- [MSPサービス](https://www.softbank.jp/business/service/platform/msp-service/)
